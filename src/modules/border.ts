...
const styles: { [key: string]: string } = {
  ...
  // Image Outset
  "io-{width$length}":                                              "margin: {width};",
  "io-{vertical$length}_{horizontal$length}":                       "margin: {vertical} {horizontal};",
  "io-{top$length}_{horizontal$length}_{bottom$length}":            "margin: {top} {horizontal} {bottom};",
  "io-{top$length}_{right$length}_{bottom$length}_{left$length}":   "margin: {top} {right} {bottom} {left};",
  ...
  "is-{width$length}":    "margin: {width};",
  "is-{vertical$length}_{horizontal$length}":                       "margin: {vertical} {horizontal};",
  "is-{top$length}_{horizontal$length}_{bottom$length}":            "margin: {top} {horizontal} {bottom};",
  "is-{top$length}_{right$length}_{bottom$length}_{left$length}":   "margin: {top} {right} {bottom} {left};",
  "is-{keyword}":                                                   "border-image-slice: {keyword};",

  // Image Width
  "iw-a":                 "border-image-width: auto;",
  "iw-auto":              "border-image-width: auto;",
  "iw-{width$length}":    "margin: {width};",
  "iw-{vertical$length}_{horizontal$length}":                       "margin: {vertical} {horizontal};",
  "iw-{top$length}_{horizontal$length}_{bottom$length}":            "margin: {top} {horizontal} {bottom};",
  "iw-{top$length}_{right$length}_{bottom$length}_{left$length}":   "margin: {top} {right} {bottom} {left};",
  "iw-{keyword}":                                                   "border-image-width: {keyword};",

  // Spacing
  "spacing-{width$length}":                           "margin: {width};",
  "spacing-{horizontal$length}_{vertical$length}":    "margin: {horizontal} {vertical};",
